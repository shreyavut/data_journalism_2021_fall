...
write_rds(shootings_w_acs, "data/shootings_w_acs.rds")


x <- shootings_w_acs %>%
  filter(is.na(estimate.population)) %>%
  group_by(state) %>%
  count()
...
## 559 shootings in neighborhoods that are majority black in a dataset of 6410

(559 / 6410) * 100
## interesting --> 8.72 percent of the total shootings were in majority black neighborhoods. 
...
(420 / 559) * 100
## which is 75.13 percent of the shootings in Black neighborhoods
...
### some mapping stuff below, is separate.
