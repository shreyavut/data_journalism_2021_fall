...
shootings_w_geoid <- bind_rows(data1, data2, data3, data4, data5, data6, data7, data8, data9, .id = NULL)

## antijoining to figure out unmatched rows
unmatched <- anti_join(shootings_w_geoid, police_shootings, by=c("id"))
...
test_census <- get_acs(geography = "tract", state="MD", 
