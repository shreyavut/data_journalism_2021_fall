...
author: "a silly little spatial join"
date: "8/24/2021"
...
**Answer** A bunch of files, that all make up a shapefile. 
...
**Answer** Data about hospitals that also includes geometric point data. 
...
**Answer** Hospitals only within Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A table of the type of hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Hospitals that are general acute care. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Counties but filtered for only in Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Counties outlined, with points where the hospitals. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A map with points of the hospitals, and a colored legend corresponding to the number of beds. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Hospitals in maryland that are general acute care with point data. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** ACS Data for the counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Two dataframes of md county population and population beds by county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Geometry for the counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Joined tables with county population and beds per county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Table joined by county and replacing one of the columns.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Addings total beds per population column.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A CHOROPLETH MAP of beds per 100k.
...
**Answer** Added log scale to make differences more clear.
