...
**Answer**
Vaccinations in a given county on a given date. 
...
**Answer** There is are several unknown and NA records.
...
**Answer** This data represents the totals of NA counties. 
...
**Answer** The most recent dates aren't necessarily higher ranks, indicating that less people are getting fully vaccinated on a given day. 
...
**Answer** We've plotted case trends based on counties!
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** Looks like like a log function of coronavirus cases by county in Md. 
...
**Answer** Which counties have the most covid cases. 
