...
**Answer** When you view source, you can see the html code that creates the page!
...
**Answer** The output displays the HTML code of the website. 
...
**Answer** In the window, you can see different information from different tables. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** You can see the table tag that provides the instructions for the table layout. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** There is a list of number one through 6 with a description of what is in each table. 
...
**Answer** A table pops up for conversion to NAICS code. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** Two is a sector and description table. 
...
**Answer** We have the clean dataset of the naics industry codes. 
...
**Answer** We once again have an NAICS industry sector table, but longer. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** Lots of tables related to workforce statistics. 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** Looks like some more html code for a table!
...
**Answer** It's extracted the html code for the table that we need!
...
**Answer** The code is now a dataframe!
...
**Answer** The result is only the employment information that we need (number of employees).
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This page shows multiple data tables for the mining sector.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** This page shows multiple data tables for the construction sector.
...
**Answer** It individually printed every one of the categories. 
```{r}
...
**Answer** The same list as above, but with slightly less code. 
```{r}
...
**Answer** Another printed list of sectors.
```{r}
...
**Answer** The object sector_list was not found, since we named our object list_of_sectors, not sector list. 
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Our list comes up again!
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** We didn't define sector_name, and so the for loop doesn't know what to print. 
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** The output is a list of numbers 1 - 10. 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** The codeblock displays our initial NAICS code table. 
...
**Answer** A list of 1 - 20, that tells us the row number. 
...
**Answer** The number of employees.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** Our cleaned naics code table. 
```{r}
# Define url of page we want to scrape
...
**Answer** Our naics code table, but with urls for each type (that's cool)!
...
**Answer** The same table as above with an added column of the id tag from the html code. 
...
**Answer** Same table with Public Administration row removed. 
...
**Answer** WOAH. Creates a table for each sector that has one row with all its information.
...
**Answer** That was a lot. It gives us the employment data for each sector in separate tables. 
...
**Answer** Takes out the information that we don't need and gives us the several tables with one row of the number of employees. 
...
**Answer** Same as before, but adds more data like the naics description, url, xpath id, etc. 
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** Table wuth sector number, name, and the jun_2021 employees. 
...
**Answer** Woah! Finished table! Everything is combined with sector number, description, and jun_2021 employees. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It shows the workforce employment statistics for the mining industry. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It shows the workforce employment statistics for the agriculture industry, which only has unemployment data, not employment data. 
...
**Answer** Agriculture has been given an NA value in the table. 
