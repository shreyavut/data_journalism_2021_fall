...
**Answer** We're taking the ppp loans, grouping by county, and counting the total number of loans in each county. Then, we're arranging them from most loans to least loans. Then, we assign this to an object. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** A bar graoh of loans by county.
...
**Answer** The graph is grouped from least to most loans by county, so it's in order now. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The graph is now sideways. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The spacing looks a lot better!
...
**Answer** The background is blue! And the lettering is larger. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** Bold title! Better labeled axes!
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** A table of apporbal data and total loans. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer**A time series line graph of approval dates and total loans.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** All of the date labels by month have been addded to the x-axis. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The dates have become slightly tilted so they are easier to read. 
