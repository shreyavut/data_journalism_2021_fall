...
To use the API, you need to [an API key from the Census Bureau](
). It takes a few minutes and you need to activate your key via email. Once you have your key, you need to set that for this session. Just FYI: Your key is your key. Do not share it.
...
**Answer** Only Somerset and Caroline County saw their median incomes fall, but neither was outside the margin of error. 
...
**Answer** 21202, 21740, and 21201 all have estimated median household incomes of less than $50,000.
