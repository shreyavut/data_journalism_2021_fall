...
**Answer**
Yes! All the column structure is the same. 
...
**Answer**
Characters (names) and doubles (numbers) can't be joined together. 
...
**Answer**
No! Some of the rows have NAs instead of data. 

```{r}
maryland_ppp_with_naics_and_demographics <- maryland_ppp_with_naics %>% 
...
**Answer**
44032 loans went to ZCTAs with more than a 50% non-Hispanic Black population. The average loan amount was $53836.46, and the median amount was $20000.
...
**Answer**
113937 loans went to ZCTAs with more than 50% non-Hispanic white population. The average amount was $88140.24, and the median amount was 20833. 
...
**Answer**
In rural areas, 148 loans went to ZCTAs with more than 50% non-Hispanic Black population, with the average loan being $44,328.87 and the median loan being $19,621. In urban areas, 43,884 loans went to the same demographic, with the average loan being $45,3868.53 and the median loan being $20,000.
...
**Answer**
In rural areas, 18,337 loans went to ZCTAs with more than 50% non-Hispanic white population, with the average loan being $73694.14	and the median loan being $20833. In urban areas, 95,600 loans with the average loan being $90,911.14 and the median loan being $20,833 went to ZCTAs of the same demographic.
